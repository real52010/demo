...
//import com.wjs.app.comm.AppConstants;
//import com.wjs.common.util.PropertyUtil;
//import com.wjs.common.util.constant.CommonConstant;
//import com.wjs.model.BusUserModel;
//import com.wjs.vo.BusBorrowBean;
...
//			}
	...
	public static void main(String[] args) throws Exception {
		System.out.println(new String(MethodUtil.getDES("b87838dcfae3eafd",	 1)));
//		Key key = getKey(CommonConstant.DES_KEY_DEFAULT.getBytes("UTF-8"));
//		
//		byte[] arrBTmp=CommonConstant.DES_KEY_DEFAULT.getBytes("UTF-8");
//		byte[] arrB = new byte[8];// 创建一个空的8位字节数组（默认值为0）
//		for (int i = 0; i < arrBTmp.length && i < arrB.length; i++) { // 将原始字节数组转换为8位
//			arrB[i] = arrBTmp[i];
//		}
...
//	 * @param msg 消息
//	 */
//	public static void writeMessageJson(HttpServletResponse response, int type,
//			String msg) {
//		Map<String, Object> map = new HashMap<String, Object>();
//		map.put("state", type);
//		if (type == 0) {
...
//	}
	...
	private static String MD5Encod(String token,String timestamp, String nonce){
...
//		 System.out.println(CommonConstant.DES_KEY_DEFAULT);
//		System.out.println(MethodUtil.getDES("4f39e73eaf0d6a26a8c7de1da15db1d2", 1));
////		  try {
////	            String url = "https://www.huilc.cn/app/rxasset/submitOrders";
////	            StringBuffer content = new StringBuffer();
////	            content.append("userid=").append(13458L);
////	            content.append("&username=").append("");
////	            content.append("&bid=").append("148659987523218");
////	            content.append("&amount=").append(100);
////	            content.append("&minTenderedSum=").append(100.00);
////	            content.append("&maxTenderedSum=").append(200.00);
////	            content.append("&investChannel=4");
////	            String nonceStr = UUID.randomUUID().toString().replaceAll("-", "");
////	            String timestamp = System.currentTimeMillis()+"";
////	            String sigenature = MD5Encod("123456789",timestamp,nonceStr);
////	            content.append("&signature=").append(sigenature);
////	            content.append("&timestamp=").append(timestamp);
////	            content.append("&nonce=").append(nonceStr);
////	            String result = HttpUtil.httpPostRequest(url, content.toString());
...
////		  try{
////				
////				String huiYouFangVerifyUrl = "https://www.huilc.cn/system/doQueryUser";
////				
////				HttpClient httpclient=new HttpClient();
////				PostMethod postmethod=new PostMethod(huiYouFangVerifyUrl);
////				JSONObject json = new JSONObject();
////				String userId = "13458";
////				json.put("userId", userId);
////				String sendTime = String.valueOf(new Date().getTime());
////				json.put("sendTime", sendTime);
////				String mac = MethodUtil.getMD5("huilc_key" + sendTime, null, 0);
////				json.put("signature", mac);
...
////		  try{
////				
////				String huiYouFangVerifyUrl = "https://www.huilc.cn/system/validatePaycode";
////				
////				HttpClient httpclient=new HttpClient();
////				PostMethod postmethod=new PostMethod(huiYouFangVerifyUrl);
////				JSONObject json = new JSONObject();
////				String userId = "13458";
////				json.put("userid", userId);
////				json.put("paycode", "135791");
////				StringBuilder builder = new StringBuilder();
////				String mac ="huilc_key" ;
////				builder.append(mac);
////				String md5Val = MethodUtil.getMD5(builder.toString(), null, 0);
////				json.put("mac", md5Val);
////				System.out.println(json.toString());
////				postmethod.setRequestBody(json.toString());
////				int responseCode=httpclient.executeMethod(postmethod);
...
////		  try{
////				
////				String huiYouFangVerifyUrl = "https://testhlc.hlej.com/system/checkPhone";
////				HttpClient httpclient=new HttpClient();
////				PostMethod postmethod=new PostMethod(huiYouFangVerifyUrl);
////				JSONObject json = new JSONObject();
////				json.put("mobilePhone", "18675515866");
////				System.out.println(json.toString());
////				postmethod.setRequestBody(json.toString());
////				int responseCode=httpclient.executeMethod(postmethod);
////				
...
//		
////		  try {
////        String url = "http://localhost:8080/mallbase/app/switchToBox";
////        HttpClient httpclient=new HttpClient();
...
//		
//		
////		String loginPwd = MethodUtil.getMD5("265huilc_key", null, 0);
////		//String mac = MethodUtil.getMD5("huilc_key" + sendTime, null, 0);
////		System.out.println(loginPwd);
////////		
////		String s  = MethodUtil.getDES("035FB027977D00EAB75129EB5CCCC65D", 1);
////		System.out.println(s);
////		
//////		String s = StringUtil.isEmpty("")?"":"Y";
//////		System.out.println("s:"+ s);
////		
////		
////		String d = MethodUtil.getSecurityNum(null,0,1);
////		System.out.println("d:"+d);
////		
////		String c = MethodUtil.getSecurityNum("4354354545332324",3,3);
////		System.out.println("c:"+c);
////		
////		String f = "ji@163.com";
////		String g = MethodUtil.getSecurityNum(f,1,1);
////		System.out.println("g:"+g);
//		
////		
////		
////		try{
////			//String huiYouFangVerifyUrl = "http://192.168.30.18:8080/mallbase/xiaozhuBus/register";
////			//String huiYouFangVerifyUrl = "http://192.168.30.18:8080/mallbase/xiaozhuBus/getInvestUser";
////			//String huiYouFangVerifyUrl = "http://www.huilc.top:8280/xiaozhuBus/register";
////			String huiYouFangVerifyUrl = "http://www.huilc.top:8280/xiaozhuBus/getInvestUser";
////			
////			//String huiYouFangVerifyUrl = "http://www.huilc.cn/xiaozhuBus/register";
////			//String huiYouFangVerifyUrl = "http://www.huilc.cn/xiaozhuBus/getInvestUser";
////			
////			HttpClient httpclient=new HttpClient();
////			PostMethod postmethod=new PostMethod(huiYouFangVerifyUrl);
////			JSONObject json = new JSONObject();
////			String mobilePhone = "18611112222";
