...
public class RequestAndResponseTool {
    ...
    public static Page sendRequstAndGetResponse(String url) throws KeyManagementException, NoSuchAlgorithmException, IOException {
...
//                getMethod.getResponseHeader("Content-Type").getValue(); // 得到当前返回类型
        Page page = new Page(body,url,null); //封装成为页面
        return page;
