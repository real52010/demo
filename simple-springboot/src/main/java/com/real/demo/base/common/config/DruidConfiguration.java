package com.real.demo.base.common.config;
...
import com.real.demo.base.common.base.dao.BaseDao;
...
@Slf4j
@Configuration
@MapperScan(basePackages = { "com.peiqi.zf.**.dao" }, sqlSessionFactoryRef = "baseSqlSessionFactory")
public class DruidConfiguration {
	...
	// setTransactionManager(@Qualifier("baseDataSource") DataSource dataSource) {
	// return new DataSourceTransactionManager(dataSource);
	// }
	//
	// @Bean(name = "baseSqlSessionFactory")
	// @Primary
	// public SqlSessionFactory setSqlSessionFactory(@Qualifier("baseDataSource")
	// DataSource dataSource) throws Exception {
	// SqlSessionFactoryBean bean = new SqlSessionFactoryBean();
	// bean.setDataSource(dataSource);
	// bean.setTypeAliasesPackage("com.peiqi.zf.*.dao");
	...
	// setSqlSessionTemplate(@Qualifier("baseSqlSessionFactory") SqlSessionFactory
